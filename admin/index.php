...
<body>
    ...
    <div class="splash-container">
        <div class="card ">
            <div class="card-header text-center" style="background-color: #297FB8"><a href="#"><h2 class="text-primary" style="    color: white !important;">Krishna Bath Products</h2></a><span class="splash-description" style="    color: white !important;">Please enter your user information.</span></div>
            <div class="card-body">
